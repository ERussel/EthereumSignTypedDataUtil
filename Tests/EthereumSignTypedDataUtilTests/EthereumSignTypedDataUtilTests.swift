import XCTest
import CryptoSwift
@testable import EthereumSignTypedDataUtil

final class EthereumSignTypedDataUtilTests: XCTestCase {
    ...
    func testEncodeAddress() throws {
        ...
        let expectResult = "000000000000000000000000cd2a3d9f938e13cd947ec05abc7fe734df8dd826"
        
        // When:
        let encoder = ABIEncoder()
        let abiValue = try ABIValue(address, type: .address)
